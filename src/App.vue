...
.border-red-1,.border-hover-red-1:hover{ border: 1px solid #e1251b; }
.border-blue-1{ border: 1px solid #aac; }
.border-dashed{	border: 1px dashed #ccc; }
.border-dashed-hover-red:hover{ border: 1px dashed #e1251b; }

.shadow,.shadow-hover:hover{ box-shadow: 0rem 0rem 0.625rem #ccc; }
.shadow-hover-blue:hover{ box-shadow: 0rem 0rem 0.625rem #acc; }
.shadow-red,.shadow-hover-red:hover{ box-shadow: 0rem 0rem 0.625rem #e1251b; }
...
.bg-hover-light:hover{background-color: #ccc;}
.bg-blue{ background-color: #aac; }
.bg-green{ background-color: #3b3; }
.bg-hover-light-green:hover{background-color: #3a3;}
